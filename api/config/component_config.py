...
COMPONENTS_CONFIG = {
    ...
    # 注释掉的组件可以通过设置enabled=False来禁用
    # "stackedAreaChart1": ComponentConfig(
    #     component_id="stackedAreaChart1",
    #     component_type="stackedAreaChart",
    #     title="板块资金流向分析",
    #     api_path="/api/chart-data/stacked-area-sector",
    #     handler="get_sector_stacked_area_data",
    #     processor_type="chart",
    #     processor_method="stacked-area-sector",
    #     position={"row": 4, "col": 4, "rowSpan": 1, "colSpan": 1},
    #     height="400px",
    #     description="板块资金流向堆叠面积图数据",
    #     source_data_keys=["plate_df"],
    #     source_data_logic="stacked_area_source_data",
    #     enabled=False
    # )
}
...
class ComponentManager:
    ...
    def __init__(self, server_instance):
        ...
        self.components = COMPONENTS_CONFIG
