...
# 启动演示仪表盘服务
gnome-terminal --title="演示仪表盘 (端口5004)" -- bash -c "echo '启动演示仪表盘服务...'; python3 api/show_plate_server_demo.py; exec bash" &
sleep 2

# 启动堆叠面积图演示服务
gnome-terminal --title="堆叠面积图演示 (端口5007)" -- bash -c "echo '启动堆叠面积图演示服务...'; python3 api/show_plate_server_multiplate_v2.py; exec bash" &
sleep 2
