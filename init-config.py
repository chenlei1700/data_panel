...
def create_universal_config():
    ...
    if generate_configs not in ['n', 'no']:
        ...
        try:
            ...
            print(f"❌ 生成配置文件时出错: {e}")
            print("请手动运行: python auto-config-generator.py")
    
    print("\n📚 相关命令:")
    print("   python auto-config-generator.py  # 生成配置文件")
    print("   python quick-add-page.py         # 添加新页面")
    print("   python check-environment.py     # 检查环境")
...
用法:
  python init-config.py        # 交互式创建配置
  python init-config.py --help # 显示帮助信息
